...
<legend><h1>오염도 측정</h1></legend>
        <form method="post" action="scratch_pro.jsp"> 
	...
	<form method="post" action="image_pro.jsp?boards=<%=seq %>" enctype="multipart/form-data"  target="iframe1">
		<table>
			<tr>
				...
				<td><div style="border:5px;display:none;"><input type="text" name="seq" value=<%=seq%>></div><td>	
			</tr>
		</table>
	</form>
